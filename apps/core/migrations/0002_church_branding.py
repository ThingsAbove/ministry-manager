# Generated by Django 5.2.15 on 2026-06-10 11:56
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='churchsettings',
            name='logo',
            field=models.ImageField(blank=True, help_text='Church logo shown in the app sidebar and admin. Leave blank to use the default.', upload_to='church/'),
        ),
        migrations.AlterField(
            model_name='churchsettings',
            name='name',
            field=models.CharField(default='Be Renewed Church', max_length=200),
        ),
    ]
